...
#I just switched all instances of Wave to Meso
...
class Week(Meso):
	...
	def week_update(self):
		...
		print(self.Weekname,"week_update weekname")
...
def name_fix(name, tag_splitter):
